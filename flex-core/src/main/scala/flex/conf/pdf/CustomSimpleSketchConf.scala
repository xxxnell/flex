...
object CustomSimpleSketchConf {
  ...
  private case class CustomSimpleSketchConfImpl(
      delta: Double,
      mixingRatio: Double,
  ...
  def apply( // dist
    ...
    bare(delta, mixingRatio, dataKernelWindow, decayFactor, cmapConf, counterConf)
  }
  ...
  def bare(
    ...
    CustomSimpleSketchConfImpl(delta, mixingRatio, dataKernelWindow, decayFactor, cmapConf, counterConf)
